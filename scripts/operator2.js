...
//결과형태 : 편의점 총 구입비는 00000원이고 남은돈은 00000원입니다.
let walletme = 10000;
let gimbob = 2000;
let icecream = 3000;
let snack = 4000;
let price = gimbob + icecream + snack;
walletme -= price;
let resultme = `편의점 총 구입비는 ${price.toLocaleString('ko-kr')}원이고 남은돈은 ${walletme.toLocaleString('ko-kr')}원입니다.`;
